<%-- 
    ...
    Created on : Jul 3, 2022, 1:10:34 AM
    Author     : Admin
--%>
...
<html>
    ...
    <main>
        <div class="container">
            ...
            <div class="list">               
                <div class="post">
                    <p>Tiêu đề: <input type="text" name="title" placeholder="Dán link nộp sản phẩm vào đây" id="link"></p>
                    <div style="color: red"><%= userError.getNotNullErrorForTitle() %> </div>
            
                    <p>Mô tả: <input type="text" name="description" placeholder="Dán link nộp sản phẩm vào đây" id="link"></p>
