                                    ...
                                    <div class="row">
                                                ...
                                                <nav class="woocommerce-MyAccount-navigation">
                                                    <ul class="list-unstyled mb-0">
                                                        ...
                                                        <li
                                                            ...
                                                            <a href="jobsApplied.jsp"
                                                               class="nav-link-style d-flex align-items-center px-4 py-3 text-dark">
                                                                ...
                                                                Danh sách công việc<span class="font-size-sm text-muted ml-auto"></span>
                                                            </a>
                                                        </li>
                                                        <li
                                                            ...
                                                            <a href="managerJob.jsp"
                                                               class="nav-link-style d-flex align-items-center px-4 py-3 text-dark">
                                                                <i class="czi-cloud-download align-middle opacity-60 mr-2"></i>
                                                                Danh sách bài đăng<span class="font-size-sm text-muted ml-auto"></span>
                                                            </a>
                                                        </li>
                                                        <li
                                                        ...
                                                        <li
                                                            ...
                                                            <a href="changePassword.jsp" class="nav-link-style d-flex align-items-center px-4 py-3 text-dark">
                                        ...
                                        <section class="col-lg-8">
                                            <div
                                                ...
                                                <h3 class="font-size-base text-dark mb-0 ml-200">Chỉnh sửa thông tin</h3>
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="e-profile">
                                                                            <div class="row">
                                                                                <div class="col-12 col-sm-auto mb-3">
                                                                                    <div class="mx-auto" style="width: 250px;">
                                                                                        <img src="avatarOfUser/<%= loginUser.getAvatar()%>" style="
                                                                                             height: 140px;
                                                                                             width: 150px;">
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <ul class="nav nav-tabs">
                                                                                <li class="nav-item"><a href="" class="active nav-link">Thông
                                                                                        tin</a></li>
                                                                            </ul>
                                                                                    ...
                                                                                    <form class="form" novalidate="">
                                                                                                    ...
                                                                                                    <div class="col">
                                                                                                        <div class="form-group">
                                                                                                            ...
                                                                                                            <input class="form-control" type="text"
                                                                                                                   name="fullname" 
                                                                                                                   value="<%= loginUser.getProfileName()%>">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="col">
                                                                                                        <div class="form-group">
                                                                                                        ...
                                                                                                        <div class="form-group">
                                                                                                            ...
                                                                                                            <input class="form-control"
                                                                                                                   ...
                                                                                                                   value="<%= loginUser.getBirthday()%>" onfocus="(this.type = 'date')">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col d-flex justify-content-center">
                                                                                                <button class="btn" type="submit" name="action" value="Edit">Lưu thông tin</button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </form>
