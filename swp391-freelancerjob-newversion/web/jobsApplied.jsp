                                                        ...
                                                        <table class="table table-stripe">
                                                            <tbody>
                                                                ...
                                                                <%
                                                                    ...
                                                                    List<ApplyDTO> jobApplied = applyDao.searchJobByAccountID(loginUser.getAccountID());
                                                                    JobDTO workingJob = new JobDTO();
                                                                    for (ApplyDTO job : jobApplied) {
                                                                        if (job.isCheckApply() == true) {
                                                                            workingJob = userDao.getJobByJobID(job.getJobID());
                                                                            if (workingJob.getStatus() == 2) {
                                                                %>
                                                                <tr>

                                                                    <td><%= workingJob.getJobName()%> </td>
                                                                    <td><%= job.getApplyTime()%></td>
                                                                    <td><%= workingJob.getDescription()%></td>
                                                                    <td><%= JobDAO.formatPrice(workingJob.getPrice()) %> VNĐ</td>

                                                                    <td><%= workingJob.getEndTime()%></td>



                                                                    <td>
                                                                        <a class="text-dark" href="WorkingController?JobID=<%= job.getJobID()%>">
                                                                            Làm việc</a>
                                                                    </td>
