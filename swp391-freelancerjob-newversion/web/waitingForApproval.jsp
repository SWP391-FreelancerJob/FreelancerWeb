<%-- 
    ...
    Created on : Jul 11, 2022, 9:19:41 AM
    Author     : Zenos
--%>
                                                        ...
                                                        <table class="table table-stripe">
                                                            <tbody>
                                                                ...
                                                                <%
                                                                    ...
                                                                    List<JobDTO> listJobWaiting = dao.getListWaitingJob(loginUser.getAccountID());
                                                                    
                                                                %>
                                                                
                                                                <%
                                                                    for (JobDTO job : listJobWaiting) {
