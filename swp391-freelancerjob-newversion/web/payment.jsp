...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="/vnpay_jsp/assets2/bootstrap.min.css" rel="stylesheet"/>
        <!-- Custom styles for this template -->
        <link href="/vnpay_jsp/assets2/jumbotron-narrow.css" rel="stylesheet">      
        <script src="/vnpay_jsp/assets2/jquery-1.11.3.min.js"></script>
    </head>
                ...
                <form action="/vnpay_jsp/vnpayajax" id="frmCreateOrder" method="post">        
                    <div class="form-group">
                        ...
                        <select name="ordertype" id="ordertype" class="form-control">
                            <option value="topup">Chuyển khoản</option>
