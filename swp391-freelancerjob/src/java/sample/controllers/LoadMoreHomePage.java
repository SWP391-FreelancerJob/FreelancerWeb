 ...
 * @author User
 */
public class LoadMoreHomePage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<JobDTO> listJob = dao.getListJobNext3Jobs(amount);
...
"                                <a id=\"tag\" href=\"MainController?action=SearchTagHomePage&tagID="+job.getTagID()+"\">"+job.getTagName()+"</a>\n" +
"                            </div>\n" +
"                        </div>");
        }
        }
